...
class CetoacidoseDiabeticaSinaisSintomasPage extends StatelessWidget {
   final String text;
  CetoacidoseDiabeticaSinaisSintomasPage({Key key, @required this.text}) : super(key: key);
          ...
          SliverList(
            delegate: SliverChildListDelegate(
              [ 
               ...
               textWithPoint(context, title:'Poliúria, polidipsia, perda de peso;'),
               ...
               textWithPoint(context, title:'Náusea e / ou vômitos, dor abdominal;'),
               textWithPoint(context, title:'Visão embaçada;'),
               textWithPoint(context, title:'Confusão;'),
               textWithPoint(context, title:'Diminuição progressiva do nível de consciência e, eventualmente, perda de consciência (coma).'),
              //  Divider(),
               teste(context, 'Os profissionais de saúde devem estar atentos à esses sintomas para oferecer o tratamento adequado ao paciente o mais rápido possível, minimizando as complicações decorrentes do quadro.'),
