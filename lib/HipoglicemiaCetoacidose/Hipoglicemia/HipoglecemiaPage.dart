          ...
          SliverList(
            delegate: SliverChildListDelegate(
              [
                ...
                textWithSomeWordsBold(context, text: 'A hipoglicemia é o principal fator limitante no manejo glicêmico do diabetes tipo 1 e tipo 2. ', textBold: 'Caracteriza-se como glicemia <70mg/dL. '),
                teste(context, 'A hipoglicemia de nível 1 é definida como uma concentração mensurável de glicose, 70 mg / dL (3,9 mmol / L), mas > 54 mg / dL (3,0 mmol / L). '),
                teste(context, 'A hipoglicemia de nível 2 (definida como uma concentração de glicose no sangue, 54 mg / dL [3,0 mmol / L]) é o limiar no qual os sintomas neuroglicopênicos começam a ocorrer e requer ação imediata para resolver o evento hipoglicêmico. '),
    ...
    return Container(
      child: Column(children: <Widget>[
        Container(
          ...
          child: Text(
            text,
            style: TextStyle(fontSize: 16, color: Colors.black, letterSpacing: 0.5),
          ),
        ),
      ]),
    );
...
Widget textWithSomeWordsBold(BuildContext context, {String textBold, String text, String underlinedText, String text2 }) {
    TextStyle defaultStyle = TextStyle(color: Colors.black, fontSize: 16.0, letterSpacing: 0.5);
